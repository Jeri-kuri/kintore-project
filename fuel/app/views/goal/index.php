...
<head>
    ...
    <?php echo Asset::js('calendar.js')?> <!--カレンダのjsファイル-->
    <?php echo Asset::js('record.js')?> <!--記録記入欄のjsファイル-->
    <?php echo Asset::js('training.js')?> <!--記録記入欄のjsファイル-->
    <?php echo Asset::js('counter.js')?>
    <?php echo Asset::js('auth.js')?>
    <?php echo Asset::js('log_edit.js')?>
